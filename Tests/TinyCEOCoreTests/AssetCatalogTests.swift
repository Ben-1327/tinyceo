...
func requiredAssetCatalogEntriesExist() throws {
    let requiredAssets: [String] = [
        ...
        "office_prop_window_blue_2dpig",
        "office_prop_window_note_2dpig",
        "office_prop_shelf_blue_2dpig",
        "office_prop_shelf_orange_2dpig",
        "office_prop_couch_blue_2dpig",
        "office_prop_couch_orange_2dpig",
        "office_prop_terminal_2dpig",
        "office_prop_chair_red_2dpig",
        "office_prop_chair_green_2dpig",
        "char_founder_01",
        "char_staff_dev_01",
        "char_staff_pm_01",
        "cat_strategy_icon",
